...
class MainView extends HookWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final isUsingDarkTheme = Theme.of(context).brightness == Brightness.dark;
    return ScreenBuilder<MainViewModel>(
        ...
        builder: (context, uiHelpers, model) => Scaffold(
              ...
              floatingActionButton: (model.isMobile(context) || model.isIndex3)
                  ...
                  : AnimatedOpacity(
                      ...
                      child: FloatingActionButton(
                        ...
                        onPressed: () {},
                        child: AnimateIcons(
                          startIcon: isUsingDarkTheme
                              ? MenuIcons.sunIcon
                              : MenuIcons.moonIcon,
                          size: 30.0,
                          controller: AnimateIconController(),
                          startTooltip:
                              isUsingDarkTheme ? 'Dark Mode' : 'Light Mode',
                          endTooltip:
                              isUsingDarkTheme ? 'Dark Mode' : 'Light Mode',
                          onStartIconPress: () {
              ...
              body: ScreenTypeLayout.builder(
                desktop: (p0) => CollapsibleSidebar(
                    selectedIconColor: isUsingDarkTheme
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: AnimateIcons(
                                    ...
                                    size: 30.0,
                                    controller: AnimateIconController(),
                                    startTooltip: isUsingDarkTheme
                                        ? 'Dark Mode'
                                        : 'Light Mode',
                                    endTooltip: !isUsingDarkTheme
                                        ? 'Dark Mode'
                                        : 'Light Mode',
                                    onStartIconPress: () {
                                      // NeumorphicTheme.of(context)!.themeMode =
